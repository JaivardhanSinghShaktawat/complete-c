...
- Format specifier is a way to tell compiler what type of data is in a variable during taking input and displaying output to the user.

- printf("This is a good boy %a.bf",var); wll print var with b decimal points in a 'a' character space.

- % is called as the convergence operator.

- printf("%0.4f",var);

- Here printf() will print var with 4 decimal points.

## Different format specifiers

1. %d : it is for integer data type
2. %f : it is for float data type
3. %lf : it is for double data type
4. %l : it for long data type
5. %Lf : it is for long double data type
6. %c : it is for character data type
